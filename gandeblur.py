...
def deblur2(weight_path, input_dir, output_dir,filen):
  g = generator_model()
  g.load_weights(weight_path)
  image = np.array([preprocess_image(load_image(input_dir))])
  x_test = image
  ...
  for i in range(generated_images.shape[0]):
    ...
    im.save(os.path.join('static','uploads','generated_'+filen))